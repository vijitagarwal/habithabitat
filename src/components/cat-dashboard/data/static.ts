import type {
  MapBar, PhaseCard, CadenceItem, HealthCard, ContingencyItem,
  ChecklistItem, BoardSeedCard, BreathPattern,
} from '../types';
...
export const CADENCE: CadenceItem[] = [
  { title: 'AUG - SEP',       desc: 'Sectionals as topics close, plus 2-3 early diagnostic full mocks in late September.' },
...
export const HEALTH_CARDS: HealthCard[] = [
  { title: 'SLEEP',      desc: '7-7.5 hrs with fixed wake time daily, including weekends. No screens 20-30 min pre-sleep.' },
  ...
  { title: 'GUT-CHECK',  desc: 'Monthly check: sustainably tired or burnt out. Cut optional add-ons first.' },
];
...
export const WEEKLY_BOARD_SEED: BoardSeedCard[] = [
  { id: 'board-flyrank',        title: 'FlyRank deliverable',          desc: 'Close remaining embeddings work and ship the portfolio-visible output.',   column: 'focus',   impact: 5, urgency: 5, effort: 4, tags: ['Tech', 'High leverage'] },
  { id: 'board-cat-daily',      title: 'CAT daily target',             desc: 'Complete the daily target and log the miss patterns immediately after.',    column: 'today',   impact: 5, urgency: 5, effort: 3, tags: ['CAT', 'Non-negotiable'] },
  { id: 'board-dsa',            title: 'DSA one-problem streak',        desc: 'One attempt-first problem to keep tech credibility alive.',                column: 'today',   impact: 4, urgency: 5, effort: 2, tags: ['DSA', 'Daily'] },
  { id: 'board-log',            title: 'Error log review',              desc: 'Scan repeating mistakes and write the one-line fix.',                      column: 'week',    impact: 5, urgency: 4, effort: 2, tags: ['Review', 'System'] },
  { id: 'board-study',          title: 'Sectional practice block',      desc: 'Timed practice tied to the current weak topic list.',                      column: 'week',    impact: 5, urgency: 4, effort: 3, tags: ['CAT', 'Practice'] },
  { id: 'board-reset',          title: 'Breathwork or meditation reset', desc: 'Protect one recovery block so the system does not decay.',               column: 'backlog', impact: 3, urgency: 3, effort: 1, tags: ['Health', 'Recovery'] },
  { id: 'board-weekly-review',  title: 'Sunday weekly review',          desc: 'Audit the week, re-rank the board, and reset the plan.',                  column: 'backlog', impact: 4, urgency: 3, effort: 2, tags: ['Planning', 'Weekly'] },
  { id: 'board-done-sample',    title: 'College admin resolved',         desc: 'Sample completed item to show the done lane and archived work.',          column: 'done',    impact: 2, urgency: 1, effort: 1, tags: ['Done'] },
];

export const BREATH_PATTERNS: Record<string, BreathPattern> = {
  box: {
    name: 'Box (4-4-4-4)',
    phases: [{ l: 'Inhale', s: 4 }, { l: 'Hold', s: 4 }, { l: 'Exhale', s: 4 }, { l: 'Hold', s: 4 }],
  },
  relax: {
    name: '4-7-8 Relax',
    phases: [{ l: 'Inhale', s: 4 }, { l: 'Hold', s: 7 }, { l: 'Exhale', s: 8 }],
  },
  coherent: {
    name: 'Coherent (5-5)',
    phases: [{ l: 'Inhale', s: 5 }, { l: 'Exhale', s: 5 }],
  },
};
...
export const TECH_LADDER = [
  { phase: 'Pre Jul 1',             label: 'Embeddings Ramp-Up',    desc: 'Complete the embeddings reading and concept gap survey before FlyRank day-one.' },
  { phase: 'Jul 1 – Aug 2',         label: 'FlyRank Deep Work',     desc: 'Build the core product: embeddings, clustering, intent classification. Ship weekly.' },
  { phase: 'Aug 3 – Aug 14',        label: 'FlyRank Wrap-Up',       desc: 'Finish all deliverables and produce a portfolio-ready case study.' },
  { phase: 'Aug 15 – Sep 30',       label: 'Portfolio Build',       desc: 'Convert FlyRank output to a public artifact. No new projects — solidify what exists.' },
  { phase: 'Oct 1 – Nov 29',        label: 'DSA Floor Only',        desc: 'One problem per day, no exceptions. Keep the streak alive. Nothing new starts.' },
];
