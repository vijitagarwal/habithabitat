...
export default function TechLadder() {
  ...
  const [draft, setDraft] = useState<Omit<TechItem, "id">>({
    phase: "",
    label: "",
    desc: "",
    startDate: "",
  ...
  const addItem = () => {
    if (!draft.label.trim() || !draft.startDate) {
      addToast("Label and start date are required.");
      return;
    }
            ...
            >
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                <div>
                  ...
                  <input
                    className="input"
                    placeholder="e.g. FlyRank Deep Work"
                    value={draft.label}
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div
                          style={{
                            ...
                            fontWeight: 600,
                            fontSize: "0.95rem",
                            color: isCurrent ? "var(--amber)" : "var(--text-primary)",
                            marginBottom: 4,
                          }}
                        >
                          {item.label}
