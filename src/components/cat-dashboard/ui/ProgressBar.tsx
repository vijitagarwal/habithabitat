...
export function ProgressBar({ value, color = 'var(--amber)', height = 4, className = '' }: ProgressBarProps) {
  return (
    <div
      className={className}
...
export function SegmentedBar({ segments, todayPct, height = 8 }: SegmentedBarProps) {
  return (
    <div style={{ height, background: 'var(--bg-raised)', borderRadius: 99, overflow: 'visible', position: 'relative' }}>
